...
for (( size=$initial_subset_size; size<=$max_training_size; size+=$increment )); do
    python train_unet.py \
        --output_dir "outputs/seunet/train/no_augmentation_$size" \
...
for (( size=$initial_subset_size; size<=$max_training_size; size+=$increment )); do
    python train_unet.py \
        --output_dir "outputs/seunet/train/rigid_transform_based_augmentation_$size" \
...
for (( size=$initial_subset_size; size<=$max_training_size; size+=$increment )); do
    python train_unet.py \
        --output_dir "outputs/seunet/train/elastic_grid_based_augmentation_$size" \
...
for (( size=$initial_subset_size; size<=$max_training_size; size+=$increment )); do
    python train_unet.py \
        --output_dir "outputs/seunet/train/bilateral_symmetry_based_augmentation_$size" \
