...
def data_augmentation_original():
    ...
    mkdirs("dentex_dataset/segmentation/enumeration32_augmentation_all/masks")
    mkdirs("dentex_dataset/segmentation/enumeration32_augmentation_all/xrays")
    ...
    for image_info in dataset_json["images"]:
        ...
        mask.save(f"dentex_dataset/segmentation/enumeration32_augmentation_all/masks/{image_info['file_name']}")
        shutil.copy(
            f"dentex_dataset/origin/quadrant_enumeration/xrays/{image_info['file_name']}",
            f"dentex_dataset/segmentation/enumeration32_augmentation_all/xrays/{image_info['file_name']}",
        )

    save_json("dentex_dataset/segmentation/enumeration32_augmentation_all/image_names.json", image_names)
...
if __name__ == "__main__":
    ...
    # Output directory
    output_dir = 'dentex_dataset/segmentation/enumeration32_augmentation_all/'
