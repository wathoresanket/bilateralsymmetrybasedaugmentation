...
def copy_data_augmentation_original():
    source_dir = 'dentex_dataset/segmentation/enumeration32_train_val_test'
    destination_dir = 'dentex_dataset/segmentation/enumeration32_bilateral_symmetry_based_augmentation_train_range'
...
if __name__ == "__main__":
    ...
    copy_data_augmentation_original()
    
    for size in range(initial_subset_size, max_training_size + 1, increment):
        input_dir = f"dentex_dataset/segmentation/enumeration32_train_val_test/train_{size}/"
        output_dir = f"dentex_dataset/segmentation/enumeration32_bilateral_symmetry_based_augmentation_train_range/train_{size}/"
